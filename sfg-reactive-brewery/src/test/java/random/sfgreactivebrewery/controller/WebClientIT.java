...
public class WebClientIT {
    ...
    void testDeleteBeer() throws InterruptedException {
        ...
        webClient.get().uri("/api/v1/beer")
                ...
                .subscribe(pagedList -> {
                    ...
                    webClient.delete().uri("/api/v1/beer/{id}", beerDto.getId())
                            .retrieve().toBodilessEntity()
                            .flatMap(responseEntity -> {
                                countDownLatch.countDown();
                                return webClient.get().uri("/api/v1/beer/{id}", beerDto.getId())
                                        .accept(MediaType.APPLICATION_JSON)
    ...
    void testUpdateBeerNotFound() throws InterruptedException {
        ...
        webClient.put().uri("/api/v1/beer/{id}", 200)
...
//                    if (throwable.getClass().getName().equals("org.springframework.web.reactive.function.client.WebClientResponseException$NotFound")) {
    ...
    void testUpdateBeer() throws InterruptedException {
        ...
        webClient.get().uri("/api/v1/beer")
                ...
                .subscribe(pagedList -> {
                    ...
                    String newBeerName = "JTsUpdate";
                    BeerDto updatePayload = BeerDto.builder().beerName(newBeerName)
                    ...
                    webClient.put().uri("/api/v1/beer/{id}", beerDto.getId())
                            .contentType(MediaType.APPLICATION_JSON)
                            .body(BodyInserters.fromValue(updatePayload))
                            .retrieve().toBodilessEntity()
                            .flatMap(responseEntity -> {
                                ...
                                assertThat(savedDto.getBeerName()).isEqualTo(newBeerName);
                                countDownLatch.countDown();
                            });
                });
    ...
    void getBeerByUPC() throws InterruptedException {
        ...
        Mono<BeerDto> beerDtoMono = webClient.get().uri("api/v1/beerUpc/{upc}", BeerLoader.BEER_2_UPC)
                .accept(MediaType.APPLICATION_JSON)
                .retrieve().bodyToMono(BeerDto.class);
