...
public class WebClientV2IT {
    ...
    void testDeleteBeer() {
        ...
        webClient.delete().uri(BeerRouterConfig.BEER_V2_URL_ID, beerId)
                .retrieve().toBodilessEntity()
                .flatMap(responseEntity -> {
                    countDownLatch.countDown();
                    return webClient.get().uri(BeerRouterConfig.BEER_V2_URL_ID, beerId)
    ...
    void testUpdateBeerNotFound() throws InterruptedException {
        ...
        webClient.put().uri(BeerRouterConfig.BEER_V2_URL_ID, beerId)
    ...
    void testUpdateBeer() throws InterruptedException {
        ...
        webClient.get().uri(BeerRouterConfig.BEER_V2_URL_ID, beerId)
                .accept(MediaType.APPLICATION_JSON)
                .retrieve().bodyToMono(BeerDto.class)
                .subscribe(beer -> {
