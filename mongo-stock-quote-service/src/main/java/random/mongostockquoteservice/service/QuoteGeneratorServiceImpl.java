...
public class QuoteGeneratorServiceImpl implements QuoteGeneratorService {
    ...
    public Flux<Quote> fetchQuoteStream(Duration period) {
        // We use here Flux.generate to create quotes, iterating on each stock starting at index 0
        return Flux.generate(() -> 0,
                ...
                // We want to emit them with a specific period; to do so, we zip that Flux with a Flux.interval
